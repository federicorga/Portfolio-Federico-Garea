...
function SectionSkills() {
  return (
    ...
    <Skills arraySkills={['NodeJS','NPM','API REST','Servidor web', 'Express', 'Passport', 'MongoDB', 'Postman','Docker','Artillery testing', 'Motor de plantillas', 'Patron de diseño','Librerías & Frameworks' ]} />
