...
function SectionPortfolio() {
  return (
    ...
    <Article img="/img/paginasimg/ruletagame.webp"  titleProyect='S.T.A.L.K.E.R Roulette React - Game ☢️' textP='Un jugo de disparos  1 vs 1 por turnos, donde deberas usar tu ingenio y los items a disposicion del inventario para ganar. Con tematica del mitico juego stalker ' 
    ...
    <Article img="/img/paginasimg/sunsound.webp"  titleProyect='SunSound NFT - Plataform 🎵' textP='Este proyecto simula un E-learning relacionado con la música, además cuenta una sección de de Artistas y sus obras musicales que se pueden reproducir.' 
    ...
    <Article img="/img/paginasimg/swagcsharp.webp" titleProyect='API Ecommerce C# - Backend 🛒' textP='Este proyecto es una API para un E-commerce Construida con lenguaje C# con registro de usuarios. Usando .NET Core, Entitiy Framework, SQL Server. Pero se puede ejecutar y abrira un Swagger' 
    ...
    <Article img='/img/paginasimg/ecommercenodejs.webp'  titleProyect='API Ecommerce NodeJS - Fullstack 🛒' textP='Este proyecto consta de una arquitectura de aplicacion completa Frontend/Backend/API/BD-MongoDB para la compra de entradas con registro de usuarios. Como lenguaje uso NodeJS y Handlebars como motor de plantillas para la generación de HTML dinámico. Cuenta con registro de usuario, test de rendimineto, etc. ' 
    ...
    <Article   img="/img/paginasimg/imagentieneda.webp" titleProyect='Ecommerce JavaScript - Frontend 🛒' textP='Este proyecto esta construido con JavaScript para la venta videojuegos. No posee BD pero se puede simular hasta la finalización de compra' 
    iconLink={ [<BtnLink imagSvg={iconGitHub} Href='https://github.com/federicorga/Ecommerce-Game-JavaScript' toolTip='ver repositorio'/>,<BtnLink imagSvg={iconlink} viewbox='0 0 24 24' Href='https://federicorga.github.io/Ecommerce-Game-JavaScript/' toolTip='ver deploy'/>]} skills={['HTML','CSS', 'JavaScript', 'Librerias']} />
        <Article img="/img/paginasimg/gamerzonereact.webp" titleProyect='Ecommerce React - Frontend + FirebaseBD🛒 ' textP='Este proyecto esta creado con React y conectado a BD de Firebase para almacenar los juegos. Se finaliza compra y se modifica la BD'
    ...
    <Article img="/img/paginasimg/soddisc.webp" titleProyect='Reproductor de vinilo React - Frontend' textP='Proyecto que simula un reproductor de vinilo funcional, con temas de Soda Stereo y Gustavo Cerati.'
    ...
    <Article img="/img/paginasimg/stalkerthezone.webp" titleProyect='S.T.A.L.K.E.R The Zone NodeJs - Fullstack ☢️ ' textP='Este proyecto esta inspirado en el juego Stalker. Construido con NodeJS. Además de la página principal, cuenta con una PDA interactiva con chat utilizando Socket.IO que permite la conexión de los usuarios en tiempo real y un minijuego "búsqueda de artefacto". Esta PDA es la misma que podemos encontrar dentro del juego y el objetivo del proyecto es recrearla'
    ...
    <Article img="/img/paginasimg/ficheroit.webp" titleProyect='Fichero-IT 🗃️' textP='Este proyecto es una biblioteca de enlaces a paginas web de programación y desarrollo web. Surgió a partir de la enorme cantidad de marcadores (enlaces) que poseía en favoritos y eran difícil de administrar. Ahora las paginas estan organizadas por secciones, posee filtros y un buscador con una interface amigable y divertida.'
    ...
    <Article img="/img/paginasimg/segurapp.webp" titleProyect='SegurAPP - Frontend' textP='Este proyecto Simula una consultora de Seguridad e Higiene. Construido con HTML, CSS y SASS fue el primer proyecto que hice'
