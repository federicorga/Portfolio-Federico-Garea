...
function SectionPortfolio() {
  return (
    ...
    <Article img="/img/paginasimg/sunsound.png"  titleProyect='SunSound NFT' textP='Este proyecto simula un E-learning relacionado con la música, además cuenta una sección de de Artistas y sus obras musicales que se pueden reproducir representadas en NFTs. 🎵' 
    ...
    <Article   img="/img/paginasimg/imagentieneda.png" titleProyect='Gamer-Zone JavaScript Frontend ' textP='Este proyecto construido con JavaScript simula un Ecommerce para la venta videojuegos 🛒' 
    ...
    iconLink={ [<BtnLink imagSvg={iconGitHub} Href='https://github.com/federicorga/API-Ecommerce-NodeJs-Backend' toolTip='ver repositorio'/>,<BtnLink imagSvg={iconlink} viewbox='0 0 24 24' Href='https://entradasrecitalesweb.glitch.me/views/login' toolTip='ver deploy'/>]} skills={['NodeJS','MongoDB','API-REST','Docker','JSW','Passport','Swagger','Artillery','Express','SocketIo','Handlebars','Mocha','Nodemailer','JavaScript','Nodemon', 'Librerias']} />
     <Article img="/img/paginasimg/stalkerthezone.png" titleProyect='S.T.A.L.K.E.R - The Zone ' textP='Este proyecto esta inspirado en el juego Stalker. Construido con NodeJS. Además de la página principal, cuenta con una PDA interactiva con chat utilizando Socket.IO que permite la conexión de los usuarios en tiempo real y un minijuego "búsqueda de artefacto". Esta PDA es la misma que podemos encontrar dentro del juego y el objetivo del proyecto es recrearla ☢️'
    ...
    <Article img="/img/paginasimg/gamerzonereact.png" titleProyect='Gamer-Zone React Frontend ' textP='Este proyecto esta creado con React usando una base de datos Firebase para almacenar los juegos. Simula la compra de videojuegos'
    ...
    <Article img="/img/paginasimg/ficheroit.png" titleProyect='Fichero-IT' textP='Este proyecto es una biblioteca de enlaces a paginas web de programación y desarrollo web. Surgió a partir de la enorme cantidad de marcadores (enlaces) que poseía en favoritos y eran difícil de administrar. Ahora las paginas estan organizadas por secciones, posee filtros y un buscador con una interface amigable y divertida. 🗃️'
    ...
    <Article img="/img/paginasimg/segurapp.png" titleProyect='SegurAPP' textP='Este proyecto Simula una consultora de Seguridad e Higiene. Construido con HTML, CSS y SASS fue el primer proyecto que hice'
